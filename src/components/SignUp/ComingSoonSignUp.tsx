    ...
    <div className="item">
      ...
      <div className="text">
        <h3 className="coming-soon-message">
          The Sign Up with university feature is coming soon! We're hard at work creating exciting new features. Stay tuned for updates!
        </h3>
      </div>
    </div>
  </div>
